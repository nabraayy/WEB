  ...
  return (
    <div className="bg-white dark:bg-gray-800 w-full py-6 sm:py-8 lg:py-12">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
          ...
          <a
            href="#"
            className="group relative flex h-50 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80"
          >
            <img
              src="/contenido/000.CON-TRABAJO/DISEÑO DE PERSONAJES/amparin_001.jpg"
              loading="lazy"
              alt="DESING"
              className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
            />
          ...
          >
            <img
              src="/contenido/cartaamihijo/010.png"
              loading="lazy"
              alt="DESING"
              className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
            />
